    ...
    public partial class PersonelHomeScreen : Form
    {
        ...
        private Panel OlusturSidebar()
        {
            ...
            if (_isYonetici)
            {
                ...
                var bKategori = new Button { Text = "  🏷️  Kategori Yönetimi", Dock = DockStyle.Top, Height = 50 };
                UiTheme.SidebarButon(bKategori);
                bKategori.Click += (s, e) => { using (var f = new KategoriYonetimForm(_oturumKullaniciAdi)) f.ShowDialog(this); };
                pnlMenu.Controls.Add(bKategori);
            }
        ...
        private void GosterGelenDilekceleri()
        {
            ...
            if (cmbKat.Items.Count <= 1)
            {
                cmbKat.Items.AddRange(new[] { "Imar & Yapi", "Sosyal Yardim", "Sikayet", "Temizlik", "Ulasim", "Su & Altyapi", "Vergi & Ruhsat", "Evlilik & Nufus", "Diger" });
            }
